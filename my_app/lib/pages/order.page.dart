...
class _OrderPageState extends State<OrderPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Meus Pedidos', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24),),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              ...
              Order orderIndividual = order.getUserOrders()[index] as Order;
